...
class ModelNotFound(CustomHTTPException):
    def __init__(self):
        super().__init__(status_code=400, detail=BaseResponseDto(code="MODEL_NOT_FOUND", message="Model not exists with this id"))
